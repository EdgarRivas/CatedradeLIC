...
inside[0] = "Nintendo Wii";
inside[1] = "../../img/cons/n3.png";
inside[2] = "Precio: $299.99";
inside[3] = "Generacion: Septima";
inside[4] = "CPU: IBM Broadway 729 MHz";
inside[5] = "MEMORIA 512Mb";
inside[6] = "Almacenamiento: Memoria Flash de 512 MB, tarjetas SD y";
inside[7] = "SDHC y tarjetas de memoria de Nintendo GameCube";
inside[8] = "GPU: ATI Hollywood 243 MHz";
