...
inside[0] = "Nvidia SHIELD";
inside[1] = "../../img/cons/n7.png";
inside[2] = "Precio: $349.99";
inside[3] = "Generacion: Octava";
inside[4] = "CPU: NVIDIA Tegra 4 Quad Core Mobile Processor";
inside[5] = "Memoria: 2GB RAM";
inside[6] = "Almacenamiento: 16Gb, tarjetas SD y";
inside[7] = "SDHC y tarjetas de memoria de Nintendo GameCube";
inside[8] = "OS: Android Jelly Bean OS";
