...
inside[0] = "iPhone 5";
inside[1] = "../../img/cels/c2.jpg";
inside[2] = "Precio: $545.99";
inside[3] = "Soporte multitouch";
inside[4] = "16GB/32GB/64GB memoria interna, 1GB RAM";
inside[5] = "Procesador Apple A6";
inside[6] = "Wi-Fi 802.11 a/b/g/n; banda dual";
inside[7] = "OS: iOS 6";
inside[8] = "Integración:Manoslibres incorporado, Reproductor y editor de audio y video, Comandos/memo/discado por voz, Asistente personal Siri, Almacenamiento iCloud, Salida TV, Editor de fotos, Integración con redes sociales, Ingreso predictivo de texto";
