...
inside[0] = "BlackBerry 10";
inside[1] = "../../img/cels/c5.jpg";
inside[2] = "Precio: $545.99";
inside[3] = "Soporte multitouch";
inside[4] = "16GB memoria interna, 1GB RAM";
inside[5] = "Procesador Qualcomm MSM8960 Snapdragon dual-core 1.5 GHz";
inside[6] = "GPU Adreno 225";
inside[7] = "OS: BlackBerry 10 OS";
inside[8] = "Integraci&oacute;n: Editor de documentos (Word, Excel, PowerPoint, PDF)";
