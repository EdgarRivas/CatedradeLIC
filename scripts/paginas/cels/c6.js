...
inside[0] = "Telefono random";
inside[1] = "../../img/cels/c6.jpg";
inside[2] = "Precio: $345.99";
inside[3] = "Soporte multitouch";
inside[4] = "16/32/64 GB memoria interna";
inside[5] = "Procesador dual-core Apple A5 1GHz, GPU PowerVR SGX543MP2";
inside[6] = "OS: iOS 5";
inside[7] = "";
inside[8] = "Integraci&oacute;n:Mapas Google, Manoslibres incorporado, Reproductor,<br>editor de audio y video, Comandos/discado por voz, Asistente<br>personal Siri, Almacenamiento iCloud, Salida TV";
