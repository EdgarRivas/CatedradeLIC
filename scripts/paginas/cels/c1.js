...
inside[0] = "Samsung Galaxy S4";
inside[1] = "../../img/cels/c1.jpg";
inside[2] = "Precio: $545.99";
inside[3] = "Soporte multitouch";
inside[4] = "16GB/32GB/64GB memoria interna, 2GB RAM";
inside[5] = "Procesador Exynos 5 Octacore 1.6 GHz";
inside[6] = "GPU PowerVR SGX 544MP / Adreno 320";
inside[7] = "OS: Android OS, v4.2.2 Jelly Bean";
inside[8] = "Integraci&oacute;n Google Search, Maps, Gmail, YouTube, Calendar, Google Talk, Picasa";
