...
inside[0] = "Samsung ATIV One 7";
inside[1] = "../../img/ord/o5.jpg";
inside[2] = "Precio: $500.00";
inside[3] = "Calificaci&oacute;n: 4.5/5";
inside[4] = "Procesador: Intel Core i5-3470T 2.9 GHz";
inside[5] = "Memoria RAM: 6GB DDR3";
inside[6] = "Disco Duro: 1 TB";
inside[7] = "Sistema operativo: Windows 8";
inside[8] = "Tarjeta gr&aacute;fica: Intel HD Graphics 2500";
