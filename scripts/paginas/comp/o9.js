...
inside[0] = "Apple iMac 27-Inch";
inside[1] = "../../img/ord/o9.jpg";
inside[2] = "Precio: $630.00";
inside[3] = "Calificaci&oacute;n: 4.5/5";
inside[4] = "Procesador: Intel Core i7-4770K 3.4 GHz";
inside[5] = "Memoria RAM: 8GB DDR3";
inside[6] = "Disco Duro: 1128 GB";
inside[7] = "Sistema operativo: Mac OS X 10.8";
inside[8] = "Tarjeta gr&aacute;fica: Nvidia GeForce GTX 680X";
